...
class PointOfInterestSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $TheCentralParkZoo = PointOfInterest::create([
            ...
            'cost' => "There are two tiers of ticket prices:
            1) cheaper without the '4D experience' at $12 for adults (no online discount)
        ...
        $DisneylandPark = PointOfInterest::create([
            ...
            'cost' => "ticket price starts from 220 dollar",
        ...
        $ErgChebbi = PointOfInterest::create([
            ...
            'cost' => "Sunset Camel Ride in Sahara Merzouga Desert Erg Chebbi Dunes from $15.85
            Camel Trekking Excursion Overnight Desert Camp Merzouga Desert Erg Chebbi Dunesfrom $73.19",
            'working_hours' => "none",
            'country_id' => 4,
        ]);
        ...
        $locketCastle = PointOfInterest::create([
            ...
            'cost' => "15 E for family and 6E for adults and 5 for studnts adn inder 18",
